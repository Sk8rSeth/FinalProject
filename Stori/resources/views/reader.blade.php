...
@section('title')
{Title of the story yo!!!}
@endsection

	@section('story_header')
		<div class="story_title">title</div>
		<div class="commits">232 commits</div>
